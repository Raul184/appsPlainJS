...
// GLOBAL----------------------------------------------------
var scores, roundScores, activePl, gamePlaying, lastDice;
...
document.querySelector('.btn-roll').addEventListener('click', function(){
    ...
    // 2. Display DICE
        ...
        // 3. Lost score if get the 6dice twice
        if( dice === 6 && lastDice === 6){
            scores[activePl] = 0;
            document.querySelector(`#score-${activePl}`).textContent = '0';
            nextPlayer();
...
document.querySelector('.btn-hold').addEventListener('click', function(){
  if(gamePlaying){
        ...
        if(scores[activePl] >=  winningScore){ document.querySelector(`#name-${activePl}`).textContent = 'Winner!!';
